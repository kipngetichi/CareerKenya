  ...
  <div class="row">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "COMPANY_NAME">Inserted Company Name:</label> 
                      <div class="col-md-8">
                         <input class="form-control input-sm" id="COMPANY_NAME" name="COMPANY_NAME" placeholder="company name"   autocomplete="none" value="<?php echo $res->COMPANY_NAME; ?>"/> 
                      </div>
                    </div>
                  </div>				  
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <textarea class="form-control input-sm" id="APPLICATIONLINK" name="APPLICATIONLINK" placeholder="Job application Link"   autocomplete="none"><?php echo $res->APPLICATIONLINK ?></textarea> 
                      </div>
                    </div>
                  </div>  
                 <div class="form-group">
