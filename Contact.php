		...
		<div class="row"> 
							<div class="col-md-12">
								<div class="about-logo">
									<h3>Contact us Here and Upload Your CV details</h3>
									<p>Upload Your CV that need be rectified here below. Note we charge <strong>Ksh 1,000,  </strong> For Resume that need to be proffesionaly rectified or Written afresh. If </p>
