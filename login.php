                        ...
                        <div class="login-box-body" style="border: solid 1px #ddd;padding: 35px;min-height: 350px;"> 
                          ...
                          <form action="" method="post">
                            <div class="form-group has-feedback">
                              <input type="text" class="form-control" placeholder="user_mail" name="user_email" id="user_email">
                          ...
                          <a style="color:green" href="<?php echo web_root; ?>index.php?q=register" class="text-center">Do You Have Account? If NOT Click Here</a>
