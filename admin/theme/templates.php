...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>CareeKenya</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>CareerKenya</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'vacancy') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/vacancy/">
            <i class="fa fa-suitcase"></i> <span>Vacancy</span> 
		       ...
		       <li class="<?php echo (currentpage() == 'localjobs') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/localjobs/">
            <i class="fa fa-suitcase"></i> <span>localjobs</span> 
          </a>
        </li>
		...
		<li class="<?php echo (currentpage() == 'CVsinformation') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/CVsinformation/">
            <i class="fa fa-suitcase"></i> <span>CVdetails</span> 
          </a>
        </li>
       <!--  <li class="treeview">
          <a href="#">
  ...
  <footer class="main-footer">
   ...
   <span style="text-align:center"> <strong>Copyright &copy; <span id="datetime"></span> <a href="#">Codesoft Technologies</a>.</strong> All rights
    reserved.</span>
  </footer>
