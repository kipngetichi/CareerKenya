                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <input type="text" class="form-control input-sm" id="APPLICATIONLINK" name="APPLICATIONLINK" placeholder="Job Link" autocomplete="none" value=" <?php echo $res->APPLICATIONLINK ?>" />
                      </div>
                    </div>
                  </div> 
                 <div class="form-group">
